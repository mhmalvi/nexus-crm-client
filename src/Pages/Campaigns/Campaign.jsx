    ...
    >
      {fbCampaignCover && (
        <>
          ...
          <div
            className={`flex h-full w-full flex-col items-center justify-center rounded-b-md px-4 py-2 font-poppins ${
              colorMode ? "bg-slate-300" : "bg-gray-800"
            }`}
          >
            <div className="flex flex-col justify-center items-center gap-4">
              <h2
                className={`max-w-[220px] overflow-hidden m-0 font-semibold text-sm text-start border-b border-brand-color ${
              ...
              <h2
                className={`w-full text-xs m-0 p-0 flex justify-between ${
                  colorMode ? "text-gray-800" : "text-slate-300"
                }`}
              >
                <span>
