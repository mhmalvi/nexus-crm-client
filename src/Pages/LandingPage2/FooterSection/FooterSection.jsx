...
const FooterSection = () => {
  return (
    <>
      <div>
        <footer
          className="section-padding footer-wrapper mt-auto"
          style={{
            borderWidth: "0px",
            borderStyle: "solid",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  className="!grid !grid-cols-12 gap-2 flex justify-center items-center mx-auto gap-x-2 gap-y-4 md:flex-row"
                  style={{
                    borderWidth: "0px",
                    borderStyle: "solid",
                    borderColor: "rgb(229, 231, 235)",
                ...
                >
                  ...
                  >
                    ...
                    >
                      <li
                        className="body-text light flex items-center md:items-start"
                        style={{
                          borderWidth: "0px",
                          borderStyle: "solid",
                          borderColor: "rgb(229, 231, 235)",
