...
const CreateStudentModal = ({
  ...
  const [letterFile, setLetterFIle] = useState(false);
  const [visaFile, setVisaFIle] = useState(false);
  const [academicFile, setAcademicFIle] = useState(false);
  const [photoVidoeFile, setPhotoVideoFIle] = useState(false);
  const [usiFile, setUsiFIle] = useState(false);
  const [payFile, setpayFIle] = useState(false);
