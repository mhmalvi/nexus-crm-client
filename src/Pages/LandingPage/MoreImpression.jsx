  ...
  return (
    <div className="impression-effects w-full m-auto rounded-3xl pb-30">
      ...
      <div className="relative mt-20">
        <div className="w-[1000px] 2xl:w-[1500px] overflow-hidden rounded-3xl shadow-lg mx-auto">
          <div className="w-[1000px] 2xl:w-[1500px] h-[700px] background-effect absolute rounded-3xl z-30"></div>
